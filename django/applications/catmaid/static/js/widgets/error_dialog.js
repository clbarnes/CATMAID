  ...
  "use strict";
    ...
    var TooManyWebGlContextsDialog = function(text, detail) {
      ...
      text = text || 'Browsers constrain how many graphics-heavy elements can be used at once. ' +
          'You have tried to open more than your browser allows.';
      var metaMsg = 'Please close whatever widget you just tried to open, and other stack viewers or 3D viewers, or' +
        ' other browser tabs if they have WebGL elements. Then re-open the widget you wanted.';
